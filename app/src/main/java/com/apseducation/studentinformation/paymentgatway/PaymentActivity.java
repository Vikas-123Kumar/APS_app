package com.apseducation.studentinformation.paymentgatway;
...
public class PaymentActivity extends Activity implements PaymentResultListener {
    ...
    public void startPayment() {
        ...
        co.setKeyID("rzp_test_xlYNtiYyWguMyj");
        try {
            RazorpayClient razorpay = new RazorpayClient("rzp_test_5nUpP8fQN0tMl3","CS5XGFMmKt12vSPjMbYgc3QU");
            JSONObject options = new JSONObject();
            options.put("name", "APS Corp");
